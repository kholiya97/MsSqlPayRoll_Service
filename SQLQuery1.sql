...
INSERT INTO employee_payroll VALUES('Himanshu','50000','12-july-2020');
INSERT INTO employee_payroll VALUES('Vishal','40000','12-jan-2010');
INSERT INTO employee_payroll VALUES('Harshpal','15000','20-mar-2018');
INSERT INTO employee_payroll VALUES('Krunal','10000','15-FEB-2010');
INSERT INTO employee_payroll VALUES('Kawasaki','5','13-apr-2025');
...
-----------------UC5---------------------
 ...
 select Salary from employee_payroll where Name='Kawasaki';
...
UPDATE employee_payroll SET Gender='M' WHERE Name='Himanshu' or Name= 'Kawasaki' or Name='Harshpal' or Name='Vishal'or Name= 'Krunal';
...
INSERT INTO employee_payroll VALUES('Dolly','25000','23-aug-2019','F','9833678738','Nainital','CS');
...
UPDATE employee_payroll SET Phone_Number='9874888670',Emp_DEPT=' Hacker', Emp_Address = 'U.S.A', Basic_Pay=12000,Deduction=5000,Taxable_Pay=2300,Income_Tax = 2564,Net_Pay=18000 WHERE Name='Himanshu';
UPDATE employee_payroll SET Phone_Number='9874117670',Emp_DEPT='Head', Emp_Address = 'Mysore', Basic_Pay=12000,Deduction=5000,Taxable_Pay=2300,Income_Tax = 2564,Net_Pay=10000 WHERE Name='Vishal';
UPDATE employee_payroll SET Phone_Number='9874227670',Emp_DEPT='Accountant', Emp_Address = 'Delhi', Basic_Pay=22000,Deduction=16000,Taxable_Pay=5300,Income_Tax = 5564,Net_Pay=22000 WHERE Name='Harshpal';
UPDATE employee_payroll SET Phone_Number='9874887670',Emp_DEPT='Developer', Emp_Address = 'Mumbai', Basic_Pay=13000,Deduction=5450,Taxable_Pay=2500,Income_Tax = 2564,Net_Pay=10000 WHERE Name='Kawasaki';
UPDATE employee_payroll SET Phone_Number='9874887670',Emp_DEPT='Marketing', Emp_Address = 'Noida', Basic_Pay=14000,Deduction=5660,Taxable_Pay=2700,Income_Tax = 3564,Net_Pay=11000 WHERE Name='Krunal';
...
INSERT INTO employee_payroll VALUES('Terissa','48548','20-dec-2020','F','8758989','Manali','Marketing','54767',4875,4555,54767,376734);
