...
select Emp_id,Emp_Name,IncomeTax from EmployeeDetails,PayrollDetails where Emp_Name='Himanshu' and  EmployeeDetails.Payroll_id=PayrollDetails.Payroll_id;
